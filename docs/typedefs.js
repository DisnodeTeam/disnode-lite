 ...
 * @property {string} channelID - Channel the message was deleted in
 * @property {string} guildID - Server the message was deleted in
 ...
 * @property {string} content - Actual Message
 * @property {string} user - Sender's Username
 * @property {string} userID - Sender's ID
 * @property {string} channelID - Channel the message was deleted in
 * @property {string} guildID - guild the message was sent in
 * @property {object} raw - Raw data sent from Discord
 */
